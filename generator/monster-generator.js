...
let traitAdjectives = ['strange','dark','ugly','terrifying','pale','tattoed'];
...
let biomeTypesTables = {
	...
	mountain: ['goblin','goblin','orc','wolf','bear','wolf','lynx','lion','spider','lizard','spider','lizard','rat','rat','human','ogre','dwarf','draconid','rat-folk','lizard-folk','huldre-troll','jotun-troll','cat-folk','wasp','bat'],
	hill: ['goblin','goblin','orc','slime','bear','wolf','wolf','lynx','lion','spider','lizard','spider','lizard','rat','rat','human','boar','ogre','dwarf','draconid','frog-folk','rat-folk','lizard-folk','huldre-troll','jotun-troll','elf','moose','cat-folk','wasp','bat'],
	...
	forest: ['goblin','goblin','orc','slime','bear','wolf','wolf','lynx','spider','lizard','spider','lizard','rat','rat','human','boar','ogre','dwarf','draconid','frog-folk','rat-folk','lizard-folk','huldre-troll','jotun-troll','elf','moose','cat-folk','wasp','bat'],
	...
	ruin: ['goblin','goblin','orc','slime','lynx','spider','lizard','spider','lizard','rat','rat','human','ogre','dwarf','draconid','frog-folk','rat-folk','lizard-folk','huldre-troll','jotun-troll','wasp','bat','bat'],
	cave: ['dragon','goblin','goblin','orc','slime','bear','spider','lizard','spider','lizard','rat','rat','human','ogre','dwarf','draconid','frog-folk','rat-folk','lizard-folk','huldre-troll','jotun-troll','wasp','bat','bat'],
