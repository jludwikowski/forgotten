...
let MonsterStats = {
    goblin() {return new Monster('goblin', 'goblin', new Attributes(10, 10, 1, 20), ItemGenerator.generateItems(), WeaponGenerator.generateWeapon(), roller.rollDice(5))},
    orc() {return new Monster('orc', 'orc', new Attributes(30, 30, 3, 20), ItemGenerator.generateItems(), WeaponGenerator.generateWeapon(), roller.rollDice(20))},
    ogre() {return new Monster('ogre', 'ogre', new Attributes(70, 70, 6, 10), ItemGenerator.generateItems(), WeaponGenerator.generateWeapon(), roller.rollDice(20))},
    slime() {return new Monster('slime', 'slime', new Attributes(40, 40, 1, 10), ItemGenerator.generateItems(), null, roller.rollDice(10))},
    ...
    human() {return new Monster('human bandit', 'human bandit', new Attributes(30, 30, 1, 20), ItemGenerator.generateItems(), WeaponGenerator.generateWeapon(), roller.rollDice(20))},
    elf() {return new Monster('elf bandit', 'elf bandit', new Attributes(20, 20, 1,  0), ItemGenerator.generateItems(), WeaponGenerator.generateWeapon(), roller.rollDice(20))},
