...
let MonsterStats = {
    goblin() {return new Monster('goblin', 'goblin', new Attributes(10, 10, 1, 20), ItemGenerator.generateEntities(), WeaponGenerator.generateEntity(), ArmorGenerator.generateEntity(), roller.rollDice(5))},
    orc() {return new Monster('orc', 'orc', new Attributes(30, 30, 3, 20), ItemGenerator.generateEntities(), WeaponGenerator.generateEntity(), ArmorGenerator.generateEntity(), roller.rollDice(20))},
    ogre() {return new Monster('ogre', 'ogre', new Attributes(70, 70, 6, 10), ItemGenerator.generateEntities(), WeaponGenerator.generateEntity(), ArmorGenerator.generateEntity(), roller.rollDice(20))},
    ...
    spider() {return new Monster('spider', 'spider', new Attributes(30, 30, 1, 30, 2), null, null, 0)},
    ...
    earth() {return new Monster('earth', 'earth', new Attributes(1.5, 1.5, 0, 0,2), null, null, 0)},
    ...
    spirit() {return new Monster('spirit', 'spirit', new Attributes(1.5, 1.5, 0, 10,1), null, null, 0)},
